...
lazy val `munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-async-http-client" % "0.23.2" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.2" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.23.2" % Test)
