...
lazy val `munit` = module
  ...
  .settings(libraryDependencies += "com.alejandrohdezma" %% "http4s-munit" % "0.8.0" % Test)
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-async-http-client" % "0.23.3" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.3" % Test)
