...
lazy val `munit` = module
  ...
  .settings(libraryDependencies += "org.typelevel" %% "munit-cats-effect-2" % "1.0.6" % Test)
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-async-http-client" % "0.23.5" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.5" % Test)
